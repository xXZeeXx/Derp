...
newCmd("update","updt","Updates the script",3,nil,{"-g (get)"}, true, function(plr,__,tags)
	if not tags[1] then
		if checkForUpdate() then
			newTablet(plr,"There is a newer version of Ebola available.",Color3.new(0,1,0))
			...
			newTablet(plr,"You have the latest version of Ebola!",Color3.new(0,1,0))
		end
	else
...
newCmd("credits","creds","Shows a list of credits",0,{"Credit Item"},{},false,function(plr,args,tags)
  if not args[1] then
	newTablet(plr,"Ebola secret ingredients",nil,'creds;nsi')
  ...
  elseif args[1]=='nsi' then
	newTablet(plr,"Ebola is made with the following:",Color3.new(1,0,.5))
  ...
  elseif args[1]=='basscans' then
	newTablet(plr,"Founder of Ebola & Ebola Tech",Color3.new(0,1,0))
	newTablet(plr,"Creator of Ebola, Ebola Reloaded, Ebola V2, Ebola Orb, Ebola Camball, Basscans' Admin, and Apollo.",Color3.new(0,1,0))
  elseif args[1]=='ultimatekiller010' then
	newTablet(plr,"Co-creator of Ebola Reloaded & Ebola V2",Color3.new(1,1,0))
	newTablet(plr, "Being a noob, and Basscans' b\127\127it\127\127ch",Color3.new(1,1,0))
  elseif args[1]=='hippalectryon' then
	newTablet(plr,"Co-creator of Ebola",Color3.new(0,0,1))
	newTablet(plr,"Co-founder of Ebola Tech",Color3.new(0,0,1))
  end
end)
...
newCmd("version","ver","Shows the current version of Ebola", 0, {},{},false,function(plr)
...
scriptingCompatability.eventConnection = game.DescendantAdded:connect(function(instance)
  pcall(function()
	...
	if getSource(instance) then
		...
		for i,v in pairs(EbolaClientQuee) do
  ...
  while wait(2.5) do
	...
	if v==true then
		...
		for cd = 30,0,-1 do
			...
			if abortShutdown then table.remove(antiban,i) msg.Text="Ebola Antiban\nShutdown aborted." wait(3) abortShutdown=false found=true break end
			if game:GetService("Players"):findFirstChild(i) then msg.Text="Ebola Antiban\nShutdown aborted (player joined)." wait(3) found=true break end
			msg.Text=-- [[ Ebola created by Basscans. ]] --
-- [[ Please do not re-disitrubte and/or distribute. ]] --
